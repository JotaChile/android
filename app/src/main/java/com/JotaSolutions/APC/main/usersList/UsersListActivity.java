...
import com.JotaSolutions.APC.adaptadores.UsersAdapter;
...
public class UsersListActivity extends BaseActivity<UsersListView, UsersListPresenter> implements UsersListView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userListType == -1) {
            throw new IllegalArgumentException("USER_LIST_TYPE ha sido definido por " + this.getClass().getSimpleName());
        }
