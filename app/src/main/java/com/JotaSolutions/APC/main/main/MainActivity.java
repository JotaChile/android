...
import com.JotaSolutions.APC.MainActivity2;
import com.JotaSolutions.APC.R;
import com.JotaSolutions.APC.adaptadores.PostsAdapter;
...
import com.JotaSolutions.APC.main.busquedas.SearchActivity;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.followingPosts:
                if (mInterstitialAd.isLoaded()) {
                    ...
                    Log.d("TAG", "El anuncio no se ha cargado");
                }
