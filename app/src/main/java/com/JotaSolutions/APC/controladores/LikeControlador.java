...
package com.JotaSolutions.APC.controladores;
...
public class LikeControlador {
    ...
    public LikeControlador(Context context, Post post, TextView likeCounterTextView,
    ...
    public void changeAnimationType() {
        if (getLikeAnimationType() == AnimationType.BOUNCE_ANIM) {
            setLikeAnimationType(AnimationType.COLOR_ANIM);
        } else {
            setLikeAnimationType(AnimationType.BOUNCE_ANIM);
        }
