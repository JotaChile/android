...
package com.JotaSolutions.APC.dialogos;
...
public class unfollowConfirmacion extends DialogFragment {
    public static final String TAG = unfollowConfirmacion.class.getSimpleName();
