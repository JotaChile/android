...
public class DatabaseHelper {
    ...
    public static final String PROFILES_DB_KEY = "perfiles";
    public static final String POST_COMMENTS_DB_KEY = "post-comentarios";
    ...
    public static final String IMAGES_STORAGE_KEY = "imagenes";
