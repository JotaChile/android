...
import com.JotaSolutions.APC.Constants;
...
public class PostViewHolder extends RecyclerView.ViewHolder {
    ...
    public PostViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity, boolean isAuthorNeeded) {
        ...
        likeViewGroup.setOnClickListener(view1 -> {
            int position = getAdapterPosition();
            if (onClickListener != null && position != RecyclerView.NO_POSITION) {
                onClickListener.onLikeClick(LikeControlador, position);
            }
        });
    ...
    public void bindData(Post post) {
        ...
        LikeControlador = new LikeControlador(context, post, likeCounterTextView, likesImageView, true);
    ...
    private OnObjectExistListener<Like> createOnLikeObjectExistListener() {
        return exist -> LikeControlador.initLike(exist);
    }

    public interface OnClickListener {
        void onItemClick(int position, View view);

        void onLikeClick(LikeControlador LikeControlador, int position);
